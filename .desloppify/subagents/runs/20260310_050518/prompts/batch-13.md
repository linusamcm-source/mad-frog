...
Repository root: /workspaces/mad-frog
Blind packet: /workspaces/mad-frog/.desloppify/review_packet_blind.json
Batch index: 13
Batch name: incomplete_migration
Batch rationale: no direct batch mapping for incomplete_migration; using representative files
...
- src/mad_frog/app.py
- main.py
- src/mad_frog/__init__.py
- src/mad_frog/__main__.py
- src/mad_frog/agent.py
- src/mad_frog/tools/__init__.py
- src/mad_frog/tools/ping.py
- src/mad_frog/mcp_server.py
- src/mad_frog/models.py
